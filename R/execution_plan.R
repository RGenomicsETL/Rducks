...
#' scalars, `VARCHAR`/`BLOB`, `DECIMAL`, `INTERVAL`, `ENUM`, and `BIT`;
#' geometry/variant and nested types are rejected at registration until the
...
# storage; DECIMAL and ENUM are handled separately below). geometry/variant and
