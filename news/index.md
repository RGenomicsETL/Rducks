...
- Direct `arrow_c` scalar/vectorized execution is wrapped in a top-level
  R error boundary so unexpected marshalling/allocation errors are
  converted into DuckDB UDF errors instead of long-jumping across the
  callback boundary.
