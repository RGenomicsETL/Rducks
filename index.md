...
this object for the UDF to keep working in DuckDB. Registering the same
SQL name/signature again replaces the callable implementation in the
shared DuckDB database catalog.
