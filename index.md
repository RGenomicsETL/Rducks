...
- `arrow_c`: native extension path for supported scalar calls with
  direct DuckDB-vector materialization. Vectorized `arrow_c` is
  intentionally not exposed until it has a direct implementation rather
  than the old Arrow/R helper bridge.
