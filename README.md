...
`rducks_register_scalar_udf()` for DuckDB scalar UDF returns and, when
declared, DuckDB scalar UDF arguments. They are also used by
...
exported through DuckDB Arrow C Data and can be returned as owned
