...
- The 'ipc' plan covers fixed-width scalars, VARCHAR/BLOB, DECIMAL, INTERVAL, ENUM, BIT, and LIST/ARRAY/STRUCT of supported types; MAP, UNION, geometry, and variant are rejected at registration.
