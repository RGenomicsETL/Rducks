...
- The 'ipc' plan covers fixed-width scalars, VARCHAR/BLOB, DECIMAL, INTERVAL, ENUM, BIT, GEOMETRY, MAP, and LIST/ARRAY/STRUCT of supported types; UNION and variant are rejected at registration.
