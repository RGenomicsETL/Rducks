...
- The 'ipc' plan covers fixed-width scalars, VARCHAR/BLOB, DECIMAL, INTERVAL, ENUM, BIT, GEOMETRY, and LIST/ARRAY/STRUCT of supported types; MAP, UNION, and variant are rejected at registration.
