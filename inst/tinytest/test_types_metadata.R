...
expect_error(rducks_value_semantics("not_a_type"), "unknown|unsupported|type")
expect_equal(nrow(rducks_value_semantics(list())), 0L)
...
expect_error(rducks_mode_semantics(1L), "mode must be a character vector")
