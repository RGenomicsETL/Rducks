...
local({
  ...
  queue_stats <- rducks_inproc_stats(con)
  expect_true(queue_stats$submitted[[1L]] >= explain$queued_chunks[[1L]])
  expect_equal(queue_stats$submitted, queue_stats$executed)
  expect_equal(queue_stats$timeouts, 0)
