...
local({
  ...
  invisible(rducks_register(con, "rducks_list_sum_arrow_c", function(x) sum(x), INTEGER[], INTEGER))
  ...
  invisible(rducks_register(con, "rducks_array_make_arrow_c", function(x) c(x, x + 1L, x + 2L), INTEGER, INTEGER[3]))
