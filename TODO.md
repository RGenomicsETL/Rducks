...
- Latest pushed baseline before this TODO:
...
Watch R-universe until it builds commits `d07770e` and `cfa8e2c` or
later.
...
Decide and document whether marshalling is a registration-time snapshot
or a query-time session choice.
...
- Current status: queue self-test and queued scalar/vectorized tests
  pass.
- Known limitation: queued scalar requests currently borrow
