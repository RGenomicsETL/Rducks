...
- **P2 observability and ergonomics**: listing UDFs, counter reset, README/docs
  examples, and richer diagnostics.
- **P3 future backends**: owned queued boundaries, native vectorized `arrow_c`,
  and Arrow IPC multiprocess execution.
...
- [ ] **P3** Design native `arrow_c + vectorized` as a first-class implementation.
